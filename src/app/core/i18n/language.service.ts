...
const translations: Record<MenoLanguage, any> = {
  ka: {
    NAV: { KITCHEN_MENU: 'სამზარეულო და მენიუ', MENUS: 'მენიუები', CATEGORIES: 'კატეგორიები', DISHES: 'კერძები', ANALYTICS: 'ანალიტიკა', AUDIT: 'აუდიტი', POS_SETTINGS: 'POS პარამეტრები', MANAGEMENT: 'მართვა', STAFF: 'პერსონალი', ROLES: 'როლები' },
  ...
  en: {
    NAV: { KITCHEN_MENU: 'KITCHEN & MENU', MENUS: 'Menus', CATEGORIES: 'Categories', DISHES: 'Dishes', ANALYTICS: 'Analytics', AUDIT: 'Audit', POS_SETTINGS: 'POS settings', MANAGEMENT: 'MANAGEMENT', STAFF: 'Staff', ROLES: 'Roles' },
