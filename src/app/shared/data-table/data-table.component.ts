...
@Component({
  ...
  styles: `:host{display:block}.filters{display:flex;align-items:center;gap:14px;margin-bottom:18px}.table{overflow:hidden;border:1px solid var(--border);border-radius:15px;background:var(--surface-card)}@media(max-width:850px){.filters{gap:8px;margin-bottom:14px}}`
})
