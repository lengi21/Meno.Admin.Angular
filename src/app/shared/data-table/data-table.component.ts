...
@Component({
  ...
  styles: `:host{display:flex;flex:1 1 0;flex-direction:column;min-height:0;overflow:hidden}.filters{display:flex;align-items:center;gap:var(--space-3);margin-bottom:var(--space-4)}.table{display:flex;flex:1 1 0;flex-direction:column;min-height:0;overflow:hidden;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface-card)}@media(max-width:850px){.filters{gap:8px;margin-bottom:14px}}`
})
